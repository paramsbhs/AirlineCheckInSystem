...
void* clerkThread(void* param) {
    ...
    while (1) {
        ...
        pthread_mutex_lock(&clerkMutex);
        while (customersRemaining > 0 && isEmpty(businessQueue) && isEmpty(economyQueue)) {
